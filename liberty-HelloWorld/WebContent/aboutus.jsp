...
<body bgcolor="#5F5454">
	...
	<br />
<div id="over">
    <img class="Centered" src="images/loggo.jpg" />
</div>


	<br />
	<br />
	<p style="text-align: center; font-family:Gabriola; font-size:150%"><font color="white"> J's Hair는 제모에 관한 상품을 파는 사이트 입니다. </font></p>
	<br />
